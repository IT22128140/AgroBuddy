    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
                  ...
                  child: Column(
                    ...
                    children: stockList.map((stock) {
                      return Container(
                        ...
                        padding: const EdgeInsets.fromLTRB(12.0, 2, 12.0, 12.0),
                        height: 200,
                            ...
                            Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(AppLocalizations.of(context)!.stockID,
                                        style: const TextStyle(
                                            fontSize: 16,
                                            fontWeight: FontWeight.bold)),
                                    Text(
                                        stock.stockID ?? '', // Handle null case
          ...
          Padding(
            padding: const EdgeInsets.only(bottom: 10.0, top: 620, right: 10),
            child: Row(
