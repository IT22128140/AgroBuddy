...
class HarvestEdit extends StatefulWidget {
  ...
  @override
  HarvestAddState createState() => HarvestAddState();
}

class HarvestAddState extends State<HarvestEdit> {
  ...
  void initState() {
    ...
    descriptionController.text = widget.data['note'];
  }
                      ...
                      : () async {
                          if (_formKey.currentState != null &&
                            ...
                            try {
                              ...
                              await databaseService.updateHarvest(
                                widget.id,
                                widget.harvestid,
                                Harvest(
